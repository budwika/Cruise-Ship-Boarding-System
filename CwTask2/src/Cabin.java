...
public class Cabin {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                case "a" :
                    add(passenger);     //using add method to add customers to rooms
                    break;
                ...
                case "d" :
                    delete(passenger);  //using delete method to remove a customer from a cabin
                    break;
    ...
    private static void add(Passenger[][] psg) {
        Scanner input = new Scanner(System.in);
        String stopadd;
        int cabinNum;
        String firstName;
        ...
        try {
            while (true) {
                ...
                if (cabinNum < 12) {    //put if condition to break the loop when its false
                    if (psg[cabinNum][0].firstName.equals("e")) {
                        for (int x = 0; x < 3; x++) {
                            System.out.println("Enter the first name of no " + x + " Passenger of cabin " + cabinNum); //assigning input values to object's attributes
                            firstName = input.next();
                            System.out.println("Enter the surname of no " + x + " Passenger of cabin " + cabinNum);
                            surName = input.next();
                            System.out.println("Enter the expenses of no " + x + " Passenger of cabin " + cabinNum);
                            expenses = input.nextInt();


                            psg[cabinNum][x] = new Passenger(firstName, surName, expenses); //assigning input values to object's attributes
                        ...
                        System.out.println("This Cabin is Already Occupied.");
                    }
                } else {
    ...
    private static void delete(Passenger[][] psg) {       //delete method to delete customers from cabins
        Scanner input = new Scanner(System.in);
        int delCabin;
        try {
            ...
            System.out.println("Removed passengers from Cabin " + delCabin + " successfully.");
        }
